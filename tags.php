...
if(isset($_GET['TAGGid'])&& isset($_GET['idth'])){
   // $array = explode(", ", "SELECT tagAr FROM");
...
<?php
    $id=$_GET['TAGGid'];
    $req="SELECT * FROM articles,themes
    WHERE articles.idTh=themes.idTh and tagsAr ='$id' and articles.idTh=$idtheme";
